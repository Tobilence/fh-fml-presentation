    ...
    <div className="mx-auto flex max-w-6xl flex-col gap-12">
      <header className="space-y-4">
        <p className="text-xs font-medium uppercase tracking-[0.24em] text-zinc-500 dark:text-zinc-400">
          CRISP-DM overview · Experiment storyline
        </p>
        ...
        <p className="max-w-2xl text-sm leading-relaxed text-zinc-600 sm:text-base dark:text-zinc-300">
          Use this page as the narrative spine for your demo: it brings together
          the business problem, experiment design, model behaviour, and risk
          perspective in one place. Each section can be a slide, a talking
          point, or a place where you swap in screenshots from your own stack.
        </p>
      </header>
      ...
      <section className="grid gap-8 md:grid-cols-[minmax(0,1.2fr)_minmax(0,1fr)] md:items-start">
        <div className="space-y-4 text-xs sm:text-sm">
          ...
          <p className="text-zinc-600 dark:text-zinc-300">
            ...
            before any modelling. Talk through sources, quality checks, and
            what you learned from simply looking at the data.
          </p>
          <div className="grid gap-3 sm:grid-cols-3">
            <div className="rounded-xl border border-zinc-200/80 bg-zinc-50 p-3 dark:border-zinc-800/80 dark:bg-zinc-900/60">
              ...
              <p className="mt-1 text-xs text-zinc-600 dark:text-zinc-300">
                Which systems and tables you pulled from, and why they are
                appropriate for this business task.
              </p>
            </div>
            <div className="rounded-xl border border-emerald-500/40 bg-emerald-50 p-3 dark:border-emerald-500/40 dark:bg-emerald-950/40">
              ...
              <p className="mt-1 text-xs text-emerald-900 dark:text-emerald-50">
                Simple profiling, missing values, stability over time, and
                anything that might worry risk or audit.
              </p>
            </div>
            <div className="rounded-xl border border-zinc-200/80 bg-zinc-50 p-3 dark:border-zinc-800/80 dark:bg-zinc-900/60">
              <div className="text-[11px] font-medium text-zinc-500 dark:text-zinc-400">
              ...
              <p className="mt-1 text-xs text-zinc-600 dark:text-zinc-300">
                Early thinking about engineered features and segments that will
                later feed into the model.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-3 rounded-2xl border border-dashed border-zinc-300/80 bg-zinc-50/80 p-5 text-xs text-zinc-600 dark:border-zinc-700/80 dark:bg-zinc-900/60 dark:text-zinc-300">
          ...
          <p>
            Reserve this space for EDA views: distributions, correlation
            heatmaps, or simple pivot tables that explain how the data behaves
            before any modelling.
          </p>
          <div className="mt-2 h-52 rounded-xl border border-dashed border-zinc-300/90 bg-gradient-to-br from-zinc-50 via-zinc-100 to-zinc-200/70 dark:border-zinc-700/80 dark:from-zinc-900 dark:via-zinc-950 dark:to-zinc-900/80 sm:h-64 md:h-72" />
          <p className="text-[11px] text-zinc-500 dark:text-zinc-400">
            You can paste in screenshots from notebooks, dashboards, or your
            profiling tool here.
          </p>
        </div>
      </section>
