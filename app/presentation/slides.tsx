...
export const PRESENTATION_SLIDES: ReadonlyArray<PresentationSlideDefinition> = [
  ...
  { status: 4, title: "Model card (federated)", Component: ModelCardSlide },
  { status: 5, title: "Model card (federated, weighted)", Component: ModelCardSlideWeighted },
  // Kept to avoid "No slide" if an older controller still emits status=6.
  { status: 6, title: "Model card (federated, weighted)", Component: ModelCardSlideWeighted },
